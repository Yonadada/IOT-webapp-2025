...
- Python은 '' 를 추천, 웹은 "" 추천
- 스타일부터 레이아웃까지 연습 
- [소스코드](./day02/html04.html)

### 웹 표준기술 - JavaScript
- Java(컴파일러 언어)와 아무런 관계가 없다 -> 실행파일o
- JavaScript(스크립트 언어) -> 실행파일x
- [소스코드](./day02/html05.html)
...
#### JavaScript 객체
- [소스코드](./day02/html06.html)
- JSON : JavaScript 객체를 표현하는 방식 
...
- DOM에서 쓰이는 주요 함수들 
    ...
    // 다중 선택 
    document.querySelectorAll(선택자); //for문으로 후 처리 
...
- jQuery  on('이벤트', function() {} ) 또는 이벤트(function () {} )
    ...
    <img src="./imageweb0002.png" width="600">

- [소스코드](./day02/html09.html)

#### Vanilla JS
- 순수 JS 불리며 JQuery처럼 CDN 링크가 필요없음
- 전통적 방식보다 효율적으로 변경됨
